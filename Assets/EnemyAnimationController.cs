...
public class EnemyAnimationController : MonoBehaviour
{
    ...
    {   
        ...
        if (this.GetComponent<EnemyMainController>())
        {
            DamageAnimationCoolDownTime = this.GetComponent<EnemyMainController>().DamageAnimationCoolDownTime;
            DamageCoolDown = null;
            AttackAnimationCoolDownTime = this.GetComponent<EnemyMainController>().AttackAnimationCoolDownTime;
            AttackCoolDown = null;
        }
