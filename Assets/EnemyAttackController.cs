...
{   
    ...
    */
    ...
    private PlayerMainController playerAttr;
    void Start() {
        player = null;
        DistanceToPlayer = 9999; // without initial value it is set to 0, otherwise may casue a bug
        
        AttackCoolDownTime = this.GetComponent<EnemyMainController>().AttackCoolDownTime;
    ...
    public void setDistanceToPlayer(GameObject player, float distance) {
        ...
        this.player = player;
        playerAttr = player.GetComponent<PlayerMainController>();
