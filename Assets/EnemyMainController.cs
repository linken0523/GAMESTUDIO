...
{   
    ...
    void Update() {
        setDistanceToPlayer(player, Mathf.Sqrt(Mathf.Pow((player.transform.position.x-this.transform.position.x),2)+Mathf.Pow((player.transform.position.z-this.transform.position.z),2)));
